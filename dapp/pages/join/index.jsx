      ...
      <NoSsr>
        ...
        <section className="presale" id="presale">
          ...
          <div className="presale-container">
            ...
            <p className="minmax">
              Minimum of 0.25 USD worth $CORE and Maximum of 10 $CORE per wallet
            </p>
              ...
              <form action="#" className="presale-form" onSubmit={confirmBuy}>
                <div className="input-group">
                  <label htmlFor="amount">
                    Balance ~
                    <span id="balance">
                      {data?.formatted || "CORE"} {data?.symbol}
                    </span>
                  </label>
                  <input
                    min={0.17}
                    ...
                    required
                    autoComplete="off"
                    placeholder="Enter Amount in wCORE"
